// v2/discovery/queue.js — Queue subtab: items table + per-item actions + ETA.
//
// Direct port from modules/utilities-javdb-discovery/queue.js.

import { esc } from '../../utils.js';
import { showJdCoverModal } from './shared.js';

// Average time between job completions (sleep + network). Conservative estimate.
