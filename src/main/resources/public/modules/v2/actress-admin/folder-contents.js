// v2 Admin tab — §4.4 Folder contents section (two-list view: videos + covers).
//
// Mirrors legacy actress-detail-admin/folder-contents.js verbatim.
// Fetched lazily and cached on titleData._folderContents.
