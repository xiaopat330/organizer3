...
public class ActressBrowseService {
    ...
    private ActressSummary toSummary(Actress actress, SummaryContext ctx) {
        ...
        return ActressSummary.builder()
                ...
                .grade(gradeDisplay)
                .computedGrade(actress.getComputedGrade() != null ? actress.getComputedGrade().display : null)
                .computedGradeScore(actress.getComputedGradeScore())
                .computedGradeN(actress.getComputedGradeN())
