...
class MountCommandTest {
    ...
    void setUp() {
        AppConfig.initializeForTest(new OrganizerConfig(
                null, null, null, null, null, null, List.of(SERVER), List.of(VOLUME_A), List.of(), List.of()));
    ...
    void switchingVolumes_closesExistingConnection() throws Exception {
        ...
        AppConfig.reset();
        AppConfig.initializeForTest(new OrganizerConfig(
                null, null, null, null, null, null, List.of(SERVER, otherServer), List.of(VOLUME_A), List.of(), List.of()));
