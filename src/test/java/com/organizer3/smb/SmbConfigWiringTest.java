...
class SmbConfigWiringTest {
    ...
    void buildSmbConfig_factory_appliesReadTimeout() {
        ...
        SmbSettings settings = new SmbSettings(3, 4, 6, 120, 30, null, 7, 9, null, null, null, null);
    ...
    void buildSmbConfig_connector_matchesFactory() {
        SmbSettings settings = new SmbSettings(5, 5, 5, 120, 30, null, 45, 45, null, null, null, null);
