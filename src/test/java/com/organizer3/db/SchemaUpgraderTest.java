...
class SchemaUpgraderTest {
    ...
    void upgradeFromV19StampsV20AndAddsNeedsProfilingColumn() {
        ...
        assertEquals(71, currentVersion());
    ...
    void freshInstallHasNeedsProfilingColumn() {
        ...
        assertEquals(71, currentVersion(), "fresh install should stamp current version (71)");
    }
    ...
    void freshInstallAtV51HasNormalizedDraftActressSchema() {
        new SchemaInitializer(jdbi).initialize();
        assertEquals(71, currentVersion(), "fresh install should stamp version 71");
    }
